    ...
    public class HttpRequest : IHttpRequest
    {
        ...
        private void ParseRequestPath()
        {
            this.Path = 
                this.Url.Split(new[] 
                {
                    HttpRequestUrlQuerySeparator,
                    HttpRequestUrlFragmentSeparator
                }, 
        ...
        private void ParseHeaders(string[] requestContent)
        {
            ...
            {
                string[] headerArguments = requestContent[currentIndex++]
                    .Split(HttpRequestHeaderNameValueSeparator);
        ...
        private void ParseCookies()
        {
            ...
            {
                string[] cookieParts = splitCookie
                    .Split(HttpRequestCookieNameValueSeparator, 2, 
